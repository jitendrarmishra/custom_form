...
{
	add_menu_page('Assignment given by Schbang', 'Custom Form', 'manage_options', 'myplugin/myplugin-admin-page.php', 'myplguin_admin_page', 'dashicons-tickets', 6);
}
function myplguin_admin_page()
{
	global $wpdb;
	$results = $wpdb->get_results("select * from wp_request");
...
?>
	...
	<table class='wp-list-table widefat fixed striped posts'>
		<tr>
			...
			<th class="manage-column ss-list-width">Service</th>
		...
		<?php foreach ($results as $row) { ?>
			<tr>
				...
				<td class="manage-column ss-list-width"><?php echo $row->Service; ?></td>
				<td class="manage-column ss-list-width"><?php echo $row->Phone; ?></td>
				<td class="manage-column ss-list-width"><?php echo $row->Date; ?></td>
